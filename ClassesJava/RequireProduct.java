...
public class RequireProduct extends javax.swing.JFrame
{
    ...
    public RequireProduct(Biblioteca biblioteca)
    {
    ...
    private void initComponents()
    {
        ...
        jLabel3 = new JLabel("REQUISITAR PRODUTO");
        ...
        jButton1 = new JButton("PESQUISAR");
        botoes.add(jButton1);
    ...
    private void jButton1MouseClicked( MouseEvent evt)
    {
        ...
        ResultadoRequisicao resultado = this.biblioteca.getUtilizadorActual().requisitaProduto( dados, livro );

        if ( resultado == ResultadoRequisicao.OK )
        {
            JOptionPane.showMessageDialog(this,"O produto foi requisitado com sucesso!");
            return;
        }

        else if ( resultado == ResultadoRequisicao.MAX )
        {
            JOptionPane.showMessageDialog(this, "Já atingiu o seu maximo de requisicoes");
            return;
        }

        else if ( resultado == ResultadoRequisicao.UNAVAILABLE )
        {
            JOptionPane.showMessageDialog(this, "O produto não está disponivel");
            return;
        }
