...
public class DeleteAdmin extends JFrame
{
    ...
    public DeleteAdmin(Biblioteca biblioteca)
    {
    ...
    private void initComponents()
    {
        ...
        jLabel3 = new JLabel("ELIMINAR ADMINISTRADOR");
        ...
        jLabel4 = new JLabel("Número de Administrador");
    ...
    private void jButton2MouseClicked( MouseEvent evt)
    {
        int numeroAdmin;
        try {
            numeroAdmin = this.caixa.getText().isEmpty()  ? 0: Integer.parseInt(this.caixa.getText());
        } catch (Exception e ) {
            JOptionPane.showMessageDialog(this, "Dados Inválidos");
            return;
        }

        Administrador a = this.biblioteca.encontraAdministrador(numeroAdmin);
        ...
        int opcao = JOptionPane.showConfirmDialog(this,"De certeza que quer eliminar o Administrador " + a.getNome() + " ?");

        if ( opcao == 0 )
        {
            ((Administrador)this.biblioteca.getUtilizadorActual()).eliminaAdministrador(a);
            JOptionPane.showMessageDialog(this,"Administrador Eliminado do Sistema");
        }
